...
background_image = pygame.image.load("santai.jpeg")
background_image = pygame.transform.scale(background_image, (900, 800))

class Balloon:
    def __init__(self, speed, image_path):
        self.image = pygame.image.load(image_path).convert_alpha()
        self.a, self.b = self.image.get_size()
...
for i in range(noBalloon):
    image_path = "X_modified.png"
    obj = Balloon(random.choice([1, 1, 2, 2, 2, 2, 3, 3, 3, 4]), image_path)
    balloons.append(obj)
